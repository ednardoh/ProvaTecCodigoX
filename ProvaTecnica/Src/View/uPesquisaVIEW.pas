...
uses
  ...
  FireDAC.Phys.Intf, uClienteControl;
...
begin
  if gblNomeTabela = 'CLIENTES' then  //caso houvesse outras tabela era só colocar um IF
  begin
...
begin
  if edtNome.Text = '' then
    ...
    begin
      if gblNomeTabela = 'CLIENTES' then
        begin //caso houvesse outras tabela era só colocar um IF
